...
base_config = {
    ...
    "training": {
        "split_level": 'wsi',  # Options: wsi, patch,
        "batch_size": 32,
    ...
    for scheduler_type in ['reduce_on_plateau']:
      for criterion_weight in ['weight10']:
        ...
        'efficientnet_b6','efficientnet_b7']:
                ...
                if image_input in [1024]:
                  config_variant["training"]["batch_size"] = 8
                  config_variant["training"]["accumulation_steps"] = 4
          
                # Update the run_name accordingly
                config_variant["paths"]["run_name"] = f"finale3/image_size_{image_input}/model_{model}"
                config_variant["paths"]["hdf5_path"] = f"data/images_{image_input}.hdf5"
