            ...
            for criterion_weight in ['None', 'equal_weight', 'weight10']:
                for optimizer_type in ['Adam', 'AdamW']:
                    for optimizer_lr in [0.0001]:
                        base_path = (
                            f"metrics/augmentation1/image_size_{image_input}/augmentation_{augmentation_type}/"
                        ...
                        for loss_function_index, loss_function in enumerate([
                            'CrossEntropyLoss', 'ReverseCrossEntropyLoss',
...
results_df.to_csv('analysis/augmentation1_model_evaluation_summary.csv', index=False)
detailed_df.to_csv('analysis/augmentation1_model_evaluation_detailed.csv', index=False)
