...
base_config = {
    ...
    "multihead":{
        "labels":         ['class',       'stain'],
        "num_classes":    [2,             4],
        "loss_functions": ['TotalCrossEntropyLoss','ReverseCrossEntropyLoss'],
        ...
        for optimizer_type in ['Adam']:
          for optimizer_lr in [0.0001]:
            ...
            'efficientnet_b3','efficientnet_b4','efficientnet_b5',
                    ...
                    config_variant["multihead"]["num_classes"] = [2,cluster]
                    ...
                    # Update the run_name accordingly
                    config_variant["paths"]["run_name"] = f"multihead2/scale_{scale_multiplier}/cluster_{cluster}/model_{model}"
                    config_variant["paths"]["hdf5_path"] = f"data/images_{image_input}.hdf5"
