...
for image_input in args.inputsize:
  # Load configuration and set up directories.
    config_path = f"configs/finale3/image_size_{image_input}/model_{args.model[0]}.yaml"
    ...
    for model in args.model:
        ...
        config_path = f"configs/finale3/{path}.yaml"
        print(f" Processing {config_path}")
        metric_num = 0
        for metric_index in range(5):
          metric_path = f"metrics/finale3/{path}/training_dict_fold{metric_index+1}.json"
