...
for image_input in [224, 384, 512,1024]:
    ...
    base_path = (f"metrics/finale/image_size_{image_input}")
...
results_df.to_csv('analysis/finale_model_evaluation_summary.csv', index=False)
detailed_df.to_csv('analysis/finale_model_evaluation_detailed.csv', index=False)
