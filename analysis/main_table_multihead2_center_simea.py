...
config_path = '/home/mdaouk/Repo/configs/finale2/image_size_224/model_Resnet18.yaml'
...
detailed_df.to_csv('analysis/tables/multihead2_center_model_evaluation_detailed.csv', index=False)
