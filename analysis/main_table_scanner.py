            ...
            for criterion_weight in ['None']:
                for optimizer_type in ['Adam']:
                    for optimizer_lr in [0.0001]:
                        base_path = (
                            f"metrics/scanner/image_size_{image_input}/augmentation_{augmentation_type}/"
...
results_df.to_csv('analysis/scanner_model_evaluation_summary.csv', index=False)
detailed_df.to_csv('analysis/scanner_model_evaluation_detailed.csv', index=False)
