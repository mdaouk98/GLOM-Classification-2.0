# src/wsi_split_utils/speed_main_train.py
...
from main_utils.train_utils import setup_logging, setup_device, setup_transforms_and_processor, DataLoadingError, train_and_evaluate_fold, save_metrics_and_checkpoint
...
def main(config_path, resume_checkpoint, full_dataset) -> None:
    ...
    train_val_indices, train_val_labels, test_indices, test_labels = split_data(all_indices, all_labels, all_wsis, config)
