...
for image_input in [224, 384, 512,1024]:
    ...
    base_path = (f"metrics/finale2/image_size_{image_input}")
    for model_index, model in enumerate(['Resnet18', 'Resnet34', 'Resnet50', 'Resnet101', 'Resnet152', 'Densenet121', 'Densenet169', 'Densenet201','Densenet264d',
                                         'efficientnet_b0', 'efficientnet_b1', 'efficientnet_b2', 'efficientnet_b3', 'efficientnet_b4','efficientnet_b5',
                                         'efficientnet_b6', 'efficientnet_b7', 'regnety_008', 'regnety_016','resnext101_32x8d', 'Vision']):
        model_title = ['R18', 'R34', 'R50', 'R101', 'R152','D121', 'D169', 'D201', 'D264d', 'Eff_b0', 'Eff_b1', 'Eff_b2', 'Eff_b3', 'Eff_b4', 'Eff_b5', 'Eff_b6', 'Eff_b7',
                       'RGy8', 'RGy16', 'RX101_32x8d', 'Vit']
        metrics_list = []
        for fold in range(1, 6):
            metric_path = (
                f"{base_path}/model_{model}/training_dict_fold{fold}.json"
            )
...
results_df.to_csv('analysis/finale2_model_evaluation_summary.csv', index=False)
detailed_df.to_csv('analysis/finale2_model_evaluation_detailed.csv', index=False)
